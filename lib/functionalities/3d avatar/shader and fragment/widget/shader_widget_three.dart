...
class ShaderWidgetThree extends StatefulWidget {
  const ShaderWidgetThree({super.key});

  @override
  _ShaderWidgetThreeState createState() => _ShaderWidgetThreeState();
}

class _ShaderWidgetThreeState extends State<ShaderWidgetThree>
  ...
  Future<void> _loadShader() async {
    final program =
        await ui.FragmentProgram.fromAsset('shaders/shadthree.frag');
    if (mounted) {
      setState(() {
