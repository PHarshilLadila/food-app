...
class ShaderWidgetTwo extends StatefulWidget {
  const ShaderWidgetTwo({super.key});

  @override
  _ShaderWidgetTwoState createState() => _ShaderWidgetTwoState();
}

class _ShaderWidgetTwoState extends State<ShaderWidgetTwo>
  ...
  Future<void> _loadShader() async {
    final program = await ui.FragmentProgram.fromAsset('shaders/shadtwo.frag');
    if (mounted) {
      setState(() {
