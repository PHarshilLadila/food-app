...
class _CartScreenState extends State<CartScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor =
        isLightTheme ? Colors.white : const Color(0xFF232323);
    final cardColor =
        isLightTheme ? Colors.black12 : const Color.fromARGB(148, 49, 59, 49);
    final textColor = isLightTheme ? AppColors.blackColor : Colors.white;
    final subTextColor = isLightTheme ? Colors.grey : Colors.grey.shade300;
    final buttonGradient = isLightTheme
        ? const LinearGradient(
            ...
            tileMode: TileMode.clamp)
        : const LinearGradient(
            colors: [Color(0xFF232323), AppColors.darkGreen],
            begin: FractionalOffset(0.0, 0.0),
            end: FractionalOffset(1.0, 0.0),
            stops: [0.0, 1.0],
            tileMode: TileMode.clamp);
