...
class HotCoffeesData extends StatefulWidget {
  final double width;
  final double height;
  final List<CoffeeModel> hotCoffee;
  final List<Map<String, dynamic>> nearestRestaurant;

  const HotCoffeesData({
    super.key,
    required this.width,
    required this.height,
    required this.hotCoffee,
    required this.nearestRestaurant,
  });

  @override
  State<HotCoffeesData> createState() => _HotCoffeesDataState();
}

class _HotCoffeesDataState extends State<HotCoffeesData> {
  @override
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        return GridView.builder(
          shrinkWrap: true,
          itemCount: widget.hotCoffee.length,
              ...
              child: GestureDetector(
                onTap: () => Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => ItemDetails(
                      itemDescription:
                          widget.hotCoffee[index].description ?? "",
                      itemImage: widget.hotCoffee[index].image ?? "",
                      itemname: widget.hotCoffee[index].title ?? "",
                      itemPrice: widget.hotCoffee[index].price!.toDouble(),
                      itemId: widget.hotCoffee[index].id.toString(),
                ...
                child: Consumer<HomeProvider>(
                  builder: (context, provider, child) {
                    debugPrint("${widget.hotCoffee.length}");
                    return Container(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Padding(
                                      ...
                                      child: AutoSizeText(
                                        "\$ ${provider.coffees[index].price.toString()}",
                                        minFontSize: 16,
                                        maxFontSize: 18,
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    provider.toggleFavoriteStatus(
                                      provider.coffees[index].id.toString(),
                                      provider.coffees[index].price.toString(),
                                  ...
                                  child: CircleAvatar(
                                    ...
                                    child: FaIcon(
                                      ...
                                      color: provider.coffees[index].isFavorite
                                          ? Colors.red
