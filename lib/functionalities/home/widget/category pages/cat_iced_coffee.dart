...
class CatIcedCoffee extends StatefulWidget {
  ...
  @override
  State<CatIcedCoffee> createState() => _CatIcedCoffeeState();
}

class _CatIcedCoffeeState extends State<CatIcedCoffee> {
                        ...
                        builder:
                          ...
                          return GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final meal = value.icedCoffee[index];
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) => ItemDetails(
                                          itemDescription: value
                                              .icedCoffee[index].description,
                                          itemImage:
                                              value.icedCoffee[index].image ??
                                                  "",
                                          itemname:
                                              value.icedCoffee[index].title ??
                                                  "",
                                          itemPrice: value
