...
class CatLunchMeal extends StatefulWidget {
  const CatLunchMeal({super.key});

  @override
  State<CatLunchMeal> createState() => _CatLunchMealState();
}

class _CatLunchMealState extends State<CatLunchMeal> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      Provider.of<HomeProvider>(context, listen: false).loadLunchData();
    });
  }
                      ...
                      return LayoutBuilder(
                        builder:
                          ...
                          return GridView.builder(
                            padding: const EdgeInsets.all(8.0),
                            itemCount: value.lunchMenu.length,
                            gridDelegate:
                            ...
                            itemBuilder: (context, index) {
                              debugPrint(
                                  "this is the pizza index : ${value.lunchMenu.length}");
                              final pizza = value.lunchMenu[index];
                                              ...
                                              child: Container(
                                                ...
                                                child: Center(
                                                  child: Padding(
                                                    ...
                                                    child: AutoSizeText(
                                                      // "\$ ${coffeePriceList[index]["price"].toString()}",
                                                      "\$ ${value.lunchMenu[index].cookTimeMinutes}",
                                                      minFontSize: 16,
                                                      maxFontSize: 18,
                                                      style:
                                                          GoogleFonts.poppins(
                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) => ItemDetails(
                                            itemDescription:
                                                value.lunchMenu[index].cuisine,
                                            itemImage:
                                                value.lunchMenu[index].image,
                                            itemname:
                                                value.lunchMenu[index].name,
                                            itemPrice:
                                                value.lunchMenu[index].rating,

                                            // value.coffees[index].price
                                            //     ?.toDouble(),
                                            itemId: value.lunchMenu[index].id
                                                .toString(),
                                            restroName:
                                                hotCoffeeNearestRestaurant[
                                                    index]['name'],
